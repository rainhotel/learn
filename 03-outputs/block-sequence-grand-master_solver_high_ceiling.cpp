...
static std::vector<SearchStage> make_search_plan(const Board& board) {
    if (board.N == 12) {
        return {
            {{150000, 4000, 1700, 18, 5, 10}, 8, 70, 0.75},
            {{ 35000, 1200,  700,  8, 3,  7}, 3, 35, 0.55},
            {{ 10000,  450,  250,  4, 2,  5}, 1,  0, 0.00},
        };
    }

    if (board.level <= 2) {
        return {
            {{210000, 4500, 2300, 22, 5, 12}, 12, 70, 0.82},
            {{ 70000, 1800, 1000, 10, 3,  8},  4, 35, 0.62},
            {{ 18000,  700,  450,  5, 2,  6},  1,  0, 0.00},
        };
    }

    return {
        {{190000, 4200, 2100, 24, 6, 12}, 10, 70, 0.78},
        {{ 60000, 1800,  950, 10, 4,  8},  4, 35, 0.58},
        {{ 15000,  600,  350,  5, 2,  6},  1,  0, 0.00},
    };
}
