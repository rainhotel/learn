...
static std::vector<SearchStage> make_search_plan(const Board& board) {
    if (board.N == 12) {
        return {
            {{150000, 4000, 1700, 18, 5, 10}, 8, 70, 0.75, 1.00},
            {{ 35000, 1200,  700,  8, 3,  7}, 3, 35, 0.55, 1.00},
    ...
    if (board.level <= 2) {
        return {
            {{310000, 6400, 3000, 34, 8, 15}, 20, 90, 0.94, 1.00},
            {{ 95000, 2500, 1250, 13, 4, 10},  6, 45, 0.72, 1.00},
            {{ 24000,  950,  520,  6, 2,  7},  1,  0, 0.00, 1.00},
        };
    }

    if (board.level == 3) {
        return {
            {{235000, 5200, 2500, 28, 7, 13}, 13, 70, 0.60, 1.10},
            {{ 70000, 1900, 1050, 11, 4,  8},  4, 35, 0.38, 1.03},
            {{ 18000,  700,  400,  5, 2,  6},  1,  0, 0.00, 1.00},
        };
    }

    if (board.level == 4) {
        return {
            {{190000, 4200, 2100, 24, 6, 12}, 10, 70, 0.78, 1.00},
            {{ 60000, 1800,  950, 10, 4,  8},  4, 35, 0.58, 1.00},
